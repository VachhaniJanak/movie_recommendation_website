# Generated by Django 4.2.13 on 2024-07-10 19:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('runtime', models.DurationField(default=datetime.timedelta(seconds=7200), null=True)),
                ('awards', models.BooleanField(default=False, null=True, verbose_name='Oscars wins')),
                ...
                ('vertical_poster', models.ImageField(upload_to='uploads/movies_posters/vertical/')),
                ('landscape_poster', models.ImageField(upload_to='uploads/movies_posters/landscape/')),
